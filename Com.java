...
//自分がリーチならかつお
        ...
        //横2こ裸はありえない
            ...
            if(index==-1){
                for(int i=0;i<=5;i++){
                    int n=0;
                    for(int j=0+i*7;j<=4+i*7;j++){
                        int su=i*7+n;
                        System.out.println(i);
                        if(area[su] == "・" && area[su+1] == "・" && area[su+2] == "・" && area[su+3] == "・" )
                        n++;
                        /*
                        index=isReach(yourOrder,j,1,moku);
                        if(index <= 34 && index != -1){
        ...
        if(index==-1){
            ...
            if(index==-1){
                for(int i=0;i<=5;i++){
                    for(int j=0+i*7;j<=4+i*7;j++){
                        index=isReach(myOrder,j,1,moku-1);
                        if(index <= 34 && index != -1){
                            if(area[index+7] == "・"){
                                auto[auto_n]=index%7+1;
                                auto_n++;
            ...
            if(index==-1){
                for(int i=0;i<=6;i++){
                    for(int j=i ; j<i+7*4 ;j+=7){
                        index=isReach(myOrder,j,7,moku-1);
                        if(index <= 34 && index != -1){
                            if(area[index+7] == "・"){
                                auto[auto_n]=index%7+1;
                                auto_n++;
            ...
            if(index==-1){
                for(int i=0;i<=3;i++){
                    for(int j=i ; j<i+7*4 ;j+=7){
                        index=isReach(myOrder,j,8,moku-1);
                        if(index <= 34 && index != -1){
                            if(area[index+7] == "・"){
                                auto[auto_n]=index%7+1;
                                auto_n++;
            ...
            if(index==-1){
                for(int i=6;i>=3;i--){
                    for(int j=i ; j<i+7*4 ;j+=7){
                        index=isReach(myOrder,j,6,moku-1);
                        if(index <= 34 && index != -1){
                            if(area[index+7] == "・"){
                                auto[auto_n]=index%7+1;
                                auto_n++;
           ...
           if(index!=-1) System.out.println("自分３つ並べたお＾＾");
        }
